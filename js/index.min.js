 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var hasRequiredScheduler_production;function requireScheduler_production(){return hasRequiredScheduler_production||(hasRequiredScheduler_production=1,(function(r){function e(pe,Ce){var ke=pe.length;pe.push(Ce);e:for(;0<ke;){var We=ke-1>>>1,re=pe[We];if(0<o(re,Ce))pe[We]=Ce,pe[ke]=re,ke=We;else break e}}function n(pe){return pe.length===0?null:pe[0]}function s(pe){if(pe.length===0)return null;var Ce=pe[0],ke=pe.pop();if(ke!==Ce){pe[0]=ke;e:for(var We=0,re=pe.length,Se=re>>>1;We<Se;){var De=2*(We+1)-1,Ie=pe[De],Le=De+1,Fe=pe[Le];if(0>o(Ie,ke))Le<re&&0>o(Fe,Ie)?(pe[We]=Fe,pe[Le]=ke,We=Le):(pe[We]=Ie,pe[De]=ke,We=De);else if(Le<re&&0>o(Fe,ke))pe[We]=Fe,pe[Le]=ke,We=Le;else break e}}return Ce}function o(pe,Ce){var ke=pe.sortIndex-Ce.sortIndex;return ke!==0?ke:pe.id-Ce.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;r.unstable_now=function(){return u.now()}}else{var d=Date,m=d.now();r.unstable_now=function(){return d.now()-m}}var p=[],g=[],b=1,W=null,X=3,de=!1,_e=!1,Te=!1,ve=!1,ye=typeof setTimeout=="function"?setTimeout:null,Re=typeof clearTimeout=="function"?clearTimeout:null,Ae=typeof setImmediate<"u"?setImmediate:null;function Pe(pe){for(var Ce=n(g);Ce!==null;){if(Ce.callback===null)s(g);else if(Ce.startTime<=pe)s(g),Ce.sortIndex=Ce.expirationTime,e(p,Ce);else break;Ce=n(g)}}function Oe(pe){if(Te=!1,Pe(pe),!_e)if(n(p)!==null)_e=!0,Ve||(Ve=!0,ue());else{var Ce=n(g);Ce!==null&&Mt(Oe,Ce.startTime-pe)}}var Ve=!1,ie=-1,Z=5,ee=-1;function ae(){return ve?!0:!(r.unstable_now()-ee<Z)}function oe(){if(ve=!1,Ve){var pe=r.unstable_now();ee=pe;var Ce=!0;try{e:{_e=!1,Te&&(Te=!1,Re(ie),ie=-1),de=!0;var ke=X;try{t:{for(Pe(pe),W=n(p);W!==null&&!(W.expirationTime>pe&&ae());){var We=W.callback;if(typeof We=="function"){W.callback=null,X=W.priorityLevel;var re=We(W.expirationTime<=pe);if(pe=r.unstable_now(),typeof re=="function"){W.callback=re,Pe(pe),Ce=!0;break t}W===n(p)&&s(p),Pe(pe)}else s(p);W=n(p)}if(W!==null)Ce=!0;else{var Se=n(g);Se!==null&&Mt(Oe,Se.startTime-pe),Ce=!1}}break e}finally{W=null,X=ke,de=!1}Ce=void 0}}finally{Ce?ue():Ve=!1}}}var ue;if(typeof Ae=="function")ue=function(){Ae(oe)};else if(typeof MessageChannel<"u"){var ne=new MessageChannel,mn=ne.port2;ne.port1.onmessage=oe,ue=function(){mn.postMessage(null)}}else ue=function(){ye(oe,0)};function Mt(pe,Ce){ie=ye(function(){pe(r.unstable_now())},Ce)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(pe){pe.callback=null},r.unstable_forceFrameRate=function(pe){0>pe||125<pe?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Z=0<pe?Math.floor(1e3/pe):5},r.unstable_getCurrentPriorityLevel=function(){return X},r.unstable_next=function(pe){switch(X){case 1:case 2:case 3:var Ce=3;break;default:Ce=X}var ke=X;X=Ce;try{return pe()}finally{X=ke}},r.unstable_requestPaint=function(){ve=!0},r.unstable_runWithPriority=function(pe,Ce){switch(pe){case 1:case 2:case 3:case 4:case 5:break;default:pe=3}var ke=X;X=pe;try{return Ce()}finally{X=ke}},r.unstable_scheduleCallback=function(pe,Ce,ke){var We=r.unstable_now();switch(typeof ke=="object"&&ke!==null?(ke=ke.delay,ke=typeof ke=="number"&&0<ke?We+ke:We):ke=We,pe){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=ke+re,pe={id:b++,callback:Ce,priorityLevel:pe,startTime:ke,expirationTime:re,sortIndex:-1},ke>We?(pe.sortIndex=ke,e(g,pe),n(p)===null&&pe===n(g)&&(Te?(Re(ie),ie=-1):Te=!0,Mt(Oe,ke-We))):(pe.sortIndex=re,e(p,pe),_e||de||(_e=!0,Ve||(Ve=!0,ue()))),pe},r.unstable_shouldYield=ae,r.unstable_wrapCallback=function(pe){var Ce=X;return function(){var ke=X;X=Ce;try{return pe.apply(this,arguments)}finally{X=ke}}}})(scheduler_production)),scheduler_production}var hasRequiredScheduler;function requireScheduler(){return hasRequiredScheduler||(hasRequiredScheduler=1,scheduler.exports=requireScheduler_production()),scheduler.exports}var reactDom={exports:{}},reactDom_production={};/**
 * @license React
...
</defs>`,_e.innerText="Preview backend running in this workspace."),_e.setAttribute("id",de)}document.readyState==="loading"?window.addEventListener("DOMContentLoaded",W):W()}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xt="WebChannelConnection";class __PRIVATE_WebChannelConnection extends __PRIVATE_RestConnection{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,n,s,o,u){const d=__PRIVATE_generateUniqueDebugId();return new Promise(((m,p)=>{const g=new XhrIo;g.setWithCredentials(!0),g.listenOnce(EventType.COMPLETE,(()=>{try{switch(g.getLastErrorCode()){case ErrorCode.NO_ERROR:const W=g.getResponseJson();__PRIVATE_logDebug(Xt,`XHR for RPC '${e}' ${d} received:`,JSON.stringify(W)),m(W);break;case ErrorCode.TIMEOUT:__PRIVATE_logDebug(Xt,`RPC '${e}' ${d} timed out`),p(new FirestoreError(N$1.DEADLINE_EXCEEDED,"Request time out"));break;case ErrorCode.HTTP_ERROR:const X=g.getStatus();if(__PRIVATE_logDebug(Xt,`RPC '${e}' ${d} failed with status:`,X,"response text:",g.getResponseText()),X>0){let de=g.getResponseJson();Array.isArray(de)&&(de=de[0]);const _e=de?.error;if(_e&&_e.status&&_e.message){const Te=(function(ye){const Re=ye.toLowerCase().replace(/_/g,"-");return Object.values(N$1).indexOf(Re)>=0?Re:N$1.UNKNOWN})(_e.status);p(new FirestoreError(Te,_e.message))}else p(new FirestoreError(N$1.UNKNOWN,"Server responded with status "+g.getStatus()))}else p(new FirestoreError(N$1.UNAVAILABLE,"Connection failed."));break;default:fail(9055,{l_:e,streamId:d,h_:g.getLastErrorCode(),P_:g.getLastError()})}}finally{__PRIVATE_logDebug(Xt,`RPC '${e}' ${d} completed.`)}}));const b=JSON.stringify(o);__PRIVATE_logDebug(Xt,`RPC '${e}' ${d} sending request:`,o),g.send(n,"POST",b,s,15)}))}T_(e,n,s){const o=__PRIVATE_generateUniqueDebugId(),u=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],d=createWebChannelTransport(),m=getStatEventTarget(),p={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},g=this.longPollingOptions.timeoutSeconds;g!==void 0&&(p.longPollingTimeout=Math.round(1e3*g)),this.useFetchStreams&&(p.useFetchStreams=!0),this.jo(p.initMessageHeaders,n,s),p.encodeInitMessageHeaders=!0;const b=u.join("");__PRIVATE_logDebug(Xt,`Creating RPC '${e}' stream ${o}: ${b}`,p);const W=d.createWebChannel(b,p);this.I_(W);let X=!1,de=!1;const _e=new __PRIVATE_StreamBridge({Yo:ve=>{de?__PRIVATE_logDebug(Xt,`Not sending because RPC '${e}' stream ${o} is closed:`,ve):(X||(__PRIVATE_logDebug(Xt,`Opening RPC '${e}' stream ${o} transport.`),W.open(),X=!0),__PRIVATE_logDebug(Xt,`RPC '${e}' stream ${o} sending:`,ve),W.send(ve))},Zo:()=>W.close()}),Te=(ve,ye,Re)=>{ve.listen(ye,(Ae=>{try{Re(Ae)}catch(Pe){setTimeout((()=>{throw Pe}),0)}}))};return Te(W,WebChannel.EventType.OPEN,(()=>{de||(__PRIVATE_logDebug(Xt,`RPC '${e}' stream ${o} transport opened.`),_e.o_())})),Te(W,WebChannel.EventType.CLOSE,(()=>{de||(de=!0,__PRIVATE_logDebug(Xt,`RPC '${e}' stream ${o} transport closed`),_e.a_(),this.E_(W))})),Te(W,WebChannel.EventType.ERROR,(ve=>{de||(de=!0,__PRIVATE_logWarn(Xt,`RPC '${e}' stream ${o} transport errored. Name:`,ve.name,"Message:",ve.message),_e.a_(new FirestoreError(N$1.UNAVAILABLE,"The operation could not be completed")))})),Te(W,WebChannel.EventType.MESSAGE,(ve=>{if(!de){const ye=ve.data[0];__PRIVATE_hardAssert(!!ye,16349);const Re=ye,Ae=Re?.error||Re[0]?.error;if(Ae){__PRIVATE_logDebug(Xt,`RPC '${e}' stream ${o} received error:`,Ae);const Pe=Ae.status;let Oe=(function(Z){const ee=pt[Z];if(ee!==void 0)return __PRIVATE_mapCodeFromRpcCode(ee)})(Pe),Ve=Ae.message;Oe===void 0&&(Oe=N$1.INTERNAL,Ve="Unknown error status: "+Pe+" with message "+Ae.message),de=!0,_e.a_(new FirestoreError(Oe,Ve)),W.close()}else __PRIVATE_logDebug(Xt,`RPC '${e}' stream ${o} received:`,ye),_e.u_(ye)}})),Te(m,Event.STAT_EVENT,(ve=>{ve.stat===Stat.PROXY?__PRIVATE_logDebug(Xt,`RPC '${e}' stream ${o} detected buffering proxy`):ve.stat===Stat.NOPROXY&&__PRIVATE_logDebug(Xt,`RPC '${e}' stream ${o} detected no buffering proxy`)})),setTimeout((()=>{_e.__()}),0),_e}terminate(){this.c_.forEach((e=>e.close())),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter((n=>n===e))}}function getDocument(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
