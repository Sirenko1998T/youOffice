 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var hasRequiredScheduler_production;function requireScheduler_production(){return hasRequiredScheduler_production||(hasRequiredScheduler_production=1,(function(r){function e(ge,Ce){var ke=ge.length;ge.push(Ce);e:for(;0<ke;){var We=ke-1>>>1,re=ge[We];if(0<o(re,Ce))ge[We]=Ce,ge[ke]=re,ke=We;else break e}}function n(ge){return ge.length===0?null:ge[0]}function s(ge){if(ge.length===0)return null;var Ce=ge[0],ke=ge.pop();if(ke!==Ce){ge[0]=ke;e:for(var We=0,re=ge.length,Se=re>>>1;We<Se;){var De=2*(We+1)-1,Ie=ge[De],Le=De+1,Fe=ge[Le];if(0>o(Ie,ke))Le<re&&0>o(Fe,Ie)?(ge[We]=Fe,ge[Le]=ke,We=Le):(ge[We]=Ie,ge[De]=ke,We=De);else if(Le<re&&0>o(Fe,ke))ge[We]=Fe,ge[Le]=ke,We=Le;else break e}}return Ce}function o(ge,Ce){var ke=ge.sortIndex-Ce.sortIndex;return ke!==0?ke:ge.id-Ce.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;r.unstable_now=function(){return u.now()}}else{var d=Date,m=d.now();r.unstable_now=function(){return d.now()-m}}var p=[],g=[],b=1,X=null,Z=3,fe=!1,ce=!1,Te=!1,_e=!1,ve=typeof setTimeout=="function"?setTimeout:null,Re=typeof clearTimeout=="function"?clearTimeout:null,Ae=typeof setImmediate<"u"?setImmediate:null;function Pe(ge){for(var Ce=n(g);Ce!==null;){if(Ce.callback===null)s(g);else if(Ce.startTime<=ge)s(g),Ce.sortIndex=Ce.expirationTime,e(p,Ce);else break;Ce=n(g)}}function Oe(ge){if(Te=!1,Pe(ge),!ce)if(n(p)!==null)ce=!0,Ve||(Ve=!0,ue());else{var Ce=n(g);Ce!==null&&Mt(Oe,Ce.startTime-ge)}}var Ve=!1,ie=-1,W=5,ee=-1;function ae(){return _e?!0:!(r.unstable_now()-ee<W)}function oe(){if(_e=!1,Ve){var ge=r.unstable_now();ee=ge;var Ce=!0;try{e:{ce=!1,Te&&(Te=!1,Re(ie),ie=-1),fe=!0;var ke=Z;try{t:{for(Pe(ge),X=n(p);X!==null&&!(X.expirationTime>ge&&ae());){var We=X.callback;if(typeof We=="function"){X.callback=null,Z=X.priorityLevel;var re=We(X.expirationTime<=ge);if(ge=r.unstable_now(),typeof re=="function"){X.callback=re,Pe(ge),Ce=!0;break t}X===n(p)&&s(p),Pe(ge)}else s(p);X=n(p)}if(X!==null)Ce=!0;else{var Se=n(g);Se!==null&&Mt(Oe,Se.startTime-ge),Ce=!1}}break e}finally{X=null,Z=ke,fe=!1}Ce=void 0}}finally{Ce?ue():Ve=!1}}}var ue;if(typeof Ae=="function")ue=function(){Ae(oe)};else if(typeof MessageChannel<"u"){var ne=new MessageChannel,mn=ne.port2;ne.port1.onmessage=oe,ue=function(){mn.postMessage(null)}}else ue=function(){ve(oe,0)};function Mt(ge,Ce){ie=ve(function(){ge(r.unstable_now())},Ce)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(ge){ge.callback=null},r.unstable_forceFrameRate=function(ge){0>ge||125<ge?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):W=0<ge?Math.floor(1e3/ge):5},r.unstable_getCurrentPriorityLevel=function(){return Z},r.unstable_next=function(ge){switch(Z){case 1:case 2:case 3:var Ce=3;break;default:Ce=Z}var ke=Z;Z=Ce;try{return ge()}finally{Z=ke}},r.unstable_requestPaint=function(){_e=!0},r.unstable_runWithPriority=function(ge,Ce){switch(ge){case 1:case 2:case 3:case 4:case 5:break;default:ge=3}var ke=Z;Z=ge;try{return Ce()}finally{Z=ke}},r.unstable_scheduleCallback=function(ge,Ce,ke){var We=r.unstable_now();switch(typeof ke=="object"&&ke!==null?(ke=ke.delay,ke=typeof ke=="number"&&0<ke?We+ke:We):ke=We,ge){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=ke+re,ge={id:b++,callback:Ce,priorityLevel:ge,startTime:ke,expirationTime:re,sortIndex:-1},ke>We?(ge.sortIndex=ke,e(g,ge),n(p)===null&&ge===n(g)&&(Te?(Re(ie),ie=-1):Te=!0,Mt(Oe,ke-We))):(ge.sortIndex=re,e(p,ge),ce||fe||(ce=!0,Ve||(Ve=!0,ue()))),ge},r.unstable_shouldYield=ae,r.unstable_wrapCallback=function(ge){var Ce=Z;return function(){var ke=Z;Z=Ce;try{return ge.apply(this,arguments)}finally{Z=ke}}}})(scheduler_production)),scheduler_production}var hasRequiredScheduler;function requireScheduler(){return hasRequiredScheduler||(hasRequiredScheduler=1,scheduler.exports=requireScheduler_production()),scheduler.exports}var reactDom={exports:{}},reactDom_production={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function createMockUserToken(r,e){if(r.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const n={alg:"none",type:"JWT"},s=e||"demo-project",o=r.iat||0,u=r.sub||r.user_id;if(!u)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const d={iss:`https://securetoken.google.com/${s}`,aud:s,iat:o,exp:o+3600,auth_time:o,sub:u,user_id:u,firebase:{sign_in_provider:"custom",identities:{}},...r};return[base64urlEncodeWithoutPadding(JSON.stringify(n)),base64urlEncodeWithoutPadding(JSON.stringify(d)),""].join(".")}const emulatorStatus={};function getEmulatorSummary(){const r={prod:[],emulator:[]};for(const e of Object.keys(emulatorStatus))emulatorStatus[e]?r.emulator.push(e):r.prod.push(e);return r}function getOrCreateEl(r){let e=document.getElementById(r),n=!1;return e||(e=document.createElement("div"),e.setAttribute("id",r),n=!0),{created:n,element:e}}let previouslyDismissed=!1;function updateEmulatorBanner(r,e){if(typeof window>"u"||typeof document>"u"||!isCloudWorkstation(window.location.host)||emulatorStatus[r]===e||emulatorStatus[r]||previouslyDismissed)return;emulatorStatus[r]=e;function n(Z){return`__firebase__banner__${Z}`}const s="__firebase__banner",u=getEmulatorSummary().prod.length>0;function d(){const Z=document.getElementById(s);Z&&Z.remove()}function m(Z){Z.style.display="flex",Z.style.background="#7faaf0",Z.style.position="fixed",Z.style.bottom="5px",Z.style.left="5px",Z.style.padding=".5em",Z.style.borderRadius="5px",Z.style.alignItems="center"}function p(Z,fe){Z.setAttribute("width","24"),Z.setAttribute("id",fe),Z.setAttribute("height","24"),Z.setAttribute("viewBox","0 0 24 24"),Z.setAttribute("fill","none"),Z.style.marginLeft="-6px"}function g(){const Z=document.createElement("span");return Z.style.cursor="pointer",Z.style.marginLeft="16px",Z.style.fontSize="24px",Z.innerHTML=" &times;",Z.onclick=()=>{previouslyDismissed=!0,d()},Z}function b(Z,fe){Z.setAttribute("id",fe),Z.innerText="Learn more",Z.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",Z.setAttribute("target","__blank"),Z.style.paddingLeft="5px",Z.style.textDecoration="underline"}function X(){const Z=getOrCreateEl(s),fe=n("text"),ce=document.getElementById(fe)||document.createElement("span"),Te=n("learnmore"),_e=document.getElementById(Te)||document.createElement("a"),ve=n("preprendIcon"),Re=document.getElementById(ve)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(Z.created){const Ae=Z.element;m(Ae),b(_e,Te);const Pe=g();p(Re,ve),Ae.append(Re,ce,_e,Pe),document.body.appendChild(Ae)}u?(ce.innerText="Preview backend disconnected.",Re.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
...
</defs>`,ce.innerText="Preview backend running in this workspace."),ce.setAttribute("id",fe)}document.readyState==="loading"?window.addEventListener("DOMContentLoaded",X):X()}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Integer,Md5;(function(){var r;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(ie,W){function ee(){}ee.prototype=W.prototype,ie.D=W.prototype,ie.prototype=new ee,ie.prototype.constructor=ie,ie.C=function(ae,oe,ue){for(var ne=Array(arguments.length-2),mn=2;mn<arguments.length;mn++)ne[mn-2]=arguments[mn];return W.prototype[oe].apply(ae,ne)}}function n(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(s,n),s.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(ie,W,ee){ee||(ee=0);var ae=Array(16);if(typeof W=="string")for(var oe=0;16>oe;++oe)ae[oe]=W.charCodeAt(ee++)|W.charCodeAt(ee++)<<8|W.charCodeAt(ee++)<<16|W.charCodeAt(ee++)<<24;else for(oe=0;16>oe;++oe)ae[oe]=W[ee++]|W[ee++]<<8|W[ee++]<<16|W[ee++]<<24;W=ie.g[0],ee=ie.g[1],oe=ie.g[2];var ue=ie.g[3],ne=W+(ue^ee&(oe^ue))+ae[0]+3614090360&4294967295;W=ee+(ne<<7&4294967295|ne>>>25),ne=ue+(oe^W&(ee^oe))+ae[1]+3905402710&4294967295,ue=W+(ne<<12&4294967295|ne>>>20),ne=oe+(ee^ue&(W^ee))+ae[2]+606105819&4294967295,oe=ue+(ne<<17&4294967295|ne>>>15),ne=ee+(W^oe&(ue^W))+ae[3]+3250441966&4294967295,ee=oe+(ne<<22&4294967295|ne>>>10),ne=W+(ue^ee&(oe^ue))+ae[4]+4118548399&4294967295,W=ee+(ne<<7&4294967295|ne>>>25),ne=ue+(oe^W&(ee^oe))+ae[5]+1200080426&4294967295,ue=W+(ne<<12&4294967295|ne>>>20),ne=oe+(ee^ue&(W^ee))+ae[6]+2821735955&4294967295,oe=ue+(ne<<17&4294967295|ne>>>15),ne=ee+(W^oe&(ue^W))+ae[7]+4249261313&4294967295,ee=oe+(ne<<22&4294967295|ne>>>10),ne=W+(ue^ee&(oe^ue))+ae[8]+1770035416&4294967295,W=ee+(ne<<7&4294967295|ne>>>25),ne=ue+(oe^W&(ee^oe))+ae[9]+2336552879&4294967295,ue=W+(ne<<12&4294967295|ne>>>20),ne=oe+(ee^ue&(W^ee))+ae[10]+4294925233&4294967295,oe=ue+(ne<<17&4294967295|ne>>>15),ne=ee+(W^oe&(ue^W))+ae[11]+2304563134&4294967295,ee=oe+(ne<<22&4294967295|ne>>>10),ne=W+(ue^ee&(oe^ue))+ae[12]+1804603682&4294967295,W=ee+(ne<<7&4294967295|ne>>>25),ne=ue+(oe^W&(ee^oe))+ae[13]+4254626195&4294967295,ue=W+(ne<<12&4294967295|ne>>>20),ne=oe+(ee^ue&(W^ee))+ae[14]+2792965006&4294967295,oe=ue+(ne<<17&4294967295|ne>>>15),ne=ee+(W^oe&(ue^W))+ae[15]+1236535329&4294967295,ee=oe+(ne<<22&4294967295|ne>>>10),ne=W+(oe^ue&(ee^oe))+ae[1]+4129170786&4294967295,W=ee+(ne<<5&4294967295|ne>>>27),ne=ue+(ee^oe&(W^ee))+ae[6]+3225465664&4294967295,ue=W+(ne<<9&4294967295|ne>>>23),ne=oe+(W^ee&(ue^W))+ae[11]+643717713&4294967295,oe=ue+(ne<<14&4294967295|ne>>>18),ne=ee+(ue^W&(oe^ue))+ae[0]+3921069994&4294967295,ee=oe+(ne<<20&4294967295|ne>>>12),ne=W+(oe^ue&(ee^oe))+ae[5]+3593408605&4294967295,W=ee+(ne<<5&4294967295|ne>>>27),ne=ue+(ee^oe&(W^ee))+ae[10]+38016083&4294967295,ue=W+(ne<<9&4294967295|ne>>>23),ne=oe+(W^ee&(ue^W))+ae[15]+3634488961&4294967295,oe=ue+(ne<<14&4294967295|ne>>>18),ne=ee+(ue^W&(oe^ue))+ae[4]+3889429448&4294967295,ee=oe+(ne<<20&4294967295|ne>>>12),ne=W+(oe^ue&(ee^oe))+ae[9]+568446438&4294967295,W=ee+(ne<<5&4294967295|ne>>>27),ne=ue+(ee^oe&(W^ee))+ae[14]+3275163606&4294967295,ue=W+(ne<<9&4294967295|ne>>>23),ne=oe+(W^ee&(ue^W))+ae[3]+4107603335&4294967295,oe=ue+(ne<<14&4294967295|ne>>>18),ne=ee+(ue^W&(oe^ue))+ae[8]+1163531501&4294967295,ee=oe+(ne<<20&4294967295|ne>>>12),ne=W+(oe^ue&(ee^oe))+ae[13]+2850285829&4294967295,W=ee+(ne<<5&4294967295|ne>>>27),ne=ue+(ee^oe&(W^ee))+ae[2]+4243563512&4294967295,ue=W+(ne<<9&4294967295|ne>>>23),ne=oe+(W^ee&(ue^W))+ae[7]+1735328473&4294967295,oe=ue+(ne<<14&4294967295|ne>>>18),ne=ee+(ue^W&(oe^ue))+ae[12]+2368359562&4294967295,ee=oe+(ne<<20&4294967295|ne>>>12),ne=W+(ee^oe^ue)+ae[5]+4294588738&4294967295,W=ee+(ne<<4&4294967295|ne>>>28),ne=ue+(W^ee^oe)+ae[8]+2272392833&4294967295,ue=W+(ne<<11&4294967295|ne>>>21),ne=oe+(ue^W^ee)+ae[11]+1839030562&4294967295,oe=ue+(ne<<16&4294967295|ne>>>16),ne=ee+(oe^ue^W)+ae[14]+4259657740&4294967295,ee=oe+(ne<<23&4294967295|ne>>>9),ne=W+(ee^oe^ue)+ae[1]+2763975236&4294967295,W=ee+(ne<<4&4294967295|ne>>>28),ne=ue+(W^ee^oe)+ae[4]+1272893353&4294967295,ue=W+(ne<<11&4294967295|ne>>>21),ne=oe+(ue^W^ee)+ae[7]+4139469664&4294967295,oe=ue+(ne<<16&4294967295|ne>>>16),ne=ee+(oe^ue^W)+ae[10]+3200236656&4294967295,ee=oe+(ne<<23&4294967295|ne>>>9),ne=W+(ee^oe^ue)+ae[13]+681279174&4294967295,W=ee+(ne<<4&4294967295|ne>>>28),ne=ue+(W^ee^oe)+ae[0]+3936430074&4294967295,ue=W+(ne<<11&4294967295|ne>>>21),ne=oe+(ue^W^ee)+ae[3]+3572445317&4294967295,oe=ue+(ne<<16&4294967295|ne>>>16),ne=ee+(oe^ue^W)+ae[6]+76029189&4294967295,ee=oe+(ne<<23&4294967295|ne>>>9),ne=W+(ee^oe^ue)+ae[9]+3654602809&4294967295,W=ee+(ne<<4&4294967295|ne>>>28),ne=ue+(W^ee^oe)+ae[12]+3873151461&4294967295,ue=W+(ne<<11&4294967295|ne>>>21),ne=oe+(ue^W^ee)+ae[15]+530742520&4294967295,oe=ue+(ne<<16&4294967295|ne>>>16),ne=ee+(oe^ue^W)+ae[2]+3299628645&4294967295,ee=oe+(ne<<23&4294967295|ne>>>9),ne=W+(oe^(ee|~ue))+ae[0]+4096336452&4294967295,W=ee+(ne<<6&4294967295|ne>>>26),ne=ue+(ee^(W|~oe))+ae[7]+1126891415&4294967295,ue=W+(ne<<10&4294967295|ne>>>22),ne=oe+(W^(ue|~ee))+ae[14]+2878612391&4294967295,oe=ue+(ne<<15&4294967295|ne>>>17),ne=ee+(ue^(oe|~W))+ae[5]+4237533241&4294967295,ee=oe+(ne<<21&4294967295|ne>>>11),ne=W+(oe^(ee|~ue))+ae[12]+1700485571&4294967295,W=ee+(ne<<6&4294967295|ne>>>26),ne=ue+(ee^(W|~oe))+ae[3]+2399980690&4294967295,ue=W+(ne<<10&4294967295|ne>>>22),ne=oe+(W^(ue|~ee))+ae[10]+4293915773&4294967295,oe=ue+(ne<<15&4294967295|ne>>>17),ne=ee+(ue^(oe|~W))+ae[1]+2240044497&4294967295,ee=oe+(ne<<21&4294967295|ne>>>11),ne=W+(oe^(ee|~ue))+ae[8]+1873313359&4294967295,W=ee+(ne<<6&4294967295|ne>>>26),ne=ue+(ee^(W|~oe))+ae[15]+4264355552&4294967295,ue=W+(ne<<10&4294967295|ne>>>22),ne=oe+(W^(ue|~ee))+ae[6]+2734768916&4294967295,oe=ue+(ne<<15&4294967295|ne>>>17),ne=ee+(ue^(oe|~W))+ae[13]+1309151649&4294967295,ee=oe+(ne<<21&4294967295|ne>>>11),ne=W+(oe^(ee|~ue))+ae[4]+4149444226&4294967295,W=ee+(ne<<6&4294967295|ne>>>26),ne=ue+(ee^(W|~oe))+ae[11]+3174756917&4294967295,ue=W+(ne<<10&4294967295|ne>>>22),ne=oe+(W^(ue|~ee))+ae[2]+718787259&4294967295,oe=ue+(ne<<15&4294967295|ne>>>17),ne=ee+(ue^(oe|~W))+ae[9]+3951481745&4294967295,ie.g[0]=ie.g[0]+W&4294967295,ie.g[1]=ie.g[1]+(oe+(ne<<21&4294967295|ne>>>11))&4294967295,ie.g[2]=ie.g[2]+oe&4294967295,ie.g[3]=ie.g[3]+ue&4294967295}s.prototype.u=function(ie,W){W===void 0&&(W=ie.length);for(var ee=W-this.blockSize,ae=this.B,oe=this.h,ue=0;ue<W;){if(oe==0)for(;ue<=ee;)o(this,ie,ue),ue+=this.blockSize;if(typeof ie=="string"){for(;ue<W;)if(ae[oe++]=ie.charCodeAt(ue++),oe==this.blockSize){o(this,ae),oe=0;break}}else for(;ue<W;)if(ae[oe++]=ie[ue++],oe==this.blockSize){o(this,ae),oe=0;break}}this.h=oe,this.o+=W},s.prototype.v=function(){var ie=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);ie[0]=128;for(var W=1;W<ie.length-8;++W)ie[W]=0;var ee=8*this.o;for(W=ie.length-8;W<ie.length;++W)ie[W]=ee&255,ee/=256;for(this.u(ie),ie=Array(16),W=ee=0;4>W;++W)for(var ae=0;32>ae;ae+=8)ie[ee++]=this.g[W]>>>ae&255;return ie};function u(ie,W){var ee=m;return Object.prototype.hasOwnProperty.call(ee,ie)?ee[ie]:ee[ie]=W(ie)}function d(ie,W){this.h=W;for(var ee=[],ae=!0,oe=ie.length-1;0<=oe;oe--){var ue=ie[oe]|0;ae&&ue==W||(ee[oe]=ue,ae=!1)}this.g=ee}var m={};function p(ie){return-128<=ie&&128>ie?u(ie,function(W){return new d([W|0],0>W?-1:0)}):new d([ie|0],0>ie?-1:0)}function g(ie){if(isNaN(ie)||!isFinite(ie))return X;if(0>ie)return _e(g(-ie));for(var W=[],ee=1,ae=0;ie>=ee;ae++)W[ae]=ie/ee|0,ee*=4294967296;return new d(W,0)}function b(ie,W){if(ie.length==0)throw Error("number format error: empty string");if(W=W||10,2>W||36<W)throw Error("radix out of range: "+W);if(ie.charAt(0)=="-")return _e(b(ie.substring(1),W));if(0<=ie.indexOf("-"))throw Error('number format error: interior "-" character');for(var ee=g(Math.pow(W,8)),ae=X,oe=0;oe<ie.length;oe+=8){var ue=Math.min(8,ie.length-oe),ne=parseInt(ie.substring(oe,oe+ue),W);8>ue?(ue=g(Math.pow(W,ue)),ae=ae.j(ue).add(g(ne))):(ae=ae.j(ee),ae=ae.add(g(ne)))}return ae}var X=p(0),Z=p(1),fe=p(16777216);r=d.prototype,r.m=function(){if(Te(this))return-_e(this).m();for(var ie=0,W=1,ee=0;ee<this.g.length;ee++){var ae=this.i(ee);ie+=(0<=ae?ae:4294967296+ae)*W,W*=4294967296}return ie},r.toString=function(ie){if(ie=ie||10,2>ie||36<ie)throw Error("radix out of range: "+ie);if(ce(this))return"0";if(Te(this))return"-"+_e(this).toString(ie);for(var W=g(Math.pow(ie,6)),ee=this,ae="";;){var oe=Pe(ee,W).g;ee=ve(ee,oe.j(W));var ue=((0<ee.g.length?ee.g[0]:ee.h)>>>0).toString(ie);if(ee=oe,ce(ee))return ue+ae;for(;6>ue.length;)ue="0"+ue;ae=ue+ae}},r.i=function(ie){return 0>ie?0:ie<this.g.length?this.g[ie]:this.h};function ce(ie){if(ie.h!=0)return!1;for(var W=0;W<ie.g.length;W++)if(ie.g[W]!=0)return!1;return!0}function Te(ie){return ie.h==-1}r.l=function(ie){return ie=ve(this,ie),Te(ie)?-1:ce(ie)?0:1};function _e(ie){for(var W=ie.g.length,ee=[],ae=0;ae<W;ae++)ee[ae]=~ie.g[ae];return new d(ee,~ie.h).add(Z)}r.abs=function(){return Te(this)?_e(this):this},r.add=function(ie){for(var W=Math.max(this.g.length,ie.g.length),ee=[],ae=0,oe=0;oe<=W;oe++){var ue=ae+(this.i(oe)&65535)+(ie.i(oe)&65535),ne=(ue>>>16)+(this.i(oe)>>>16)+(ie.i(oe)>>>16);ae=ne>>>16,ue&=65535,ne&=65535,ee[oe]=ne<<16|ue}return new d(ee,ee[ee.length-1]&-2147483648?-1:0)};function ve(ie,W){return ie.add(_e(W))}r.j=function(ie){if(ce(this)||ce(ie))return X;if(Te(this))return Te(ie)?_e(this).j(_e(ie)):_e(_e(this).j(ie));if(Te(ie))return _e(this.j(_e(ie)));if(0>this.l(fe)&&0>ie.l(fe))return g(this.m()*ie.m());for(var W=this.g.length+ie.g.length,ee=[],ae=0;ae<2*W;ae++)ee[ae]=0;for(ae=0;ae<this.g.length;ae++)for(var oe=0;oe<ie.g.length;oe++){var ue=this.i(ae)>>>16,ne=this.i(ae)&65535,mn=ie.i(oe)>>>16,Mt=ie.i(oe)&65535;ee[2*ae+2*oe]+=ne*Mt,Re(ee,2*ae+2*oe),ee[2*ae+2*oe+1]+=ue*Mt,Re(ee,2*ae+2*oe+1),ee[2*ae+2*oe+1]+=ne*mn,Re(ee,2*ae+2*oe+1),ee[2*ae+2*oe+2]+=ue*mn,Re(ee,2*ae+2*oe+2)}for(ae=0;ae<W;ae++)ee[ae]=ee[2*ae+1]<<16|ee[2*ae];for(ae=W;ae<2*W;ae++)ee[ae]=0;return new d(ee,0)};function Re(ie,W){for(;(ie[W]&65535)!=ie[W];)ie[W+1]+=ie[W]>>>16,ie[W]&=65535,W++}function Ae(ie,W){this.g=ie,this.h=W}function Pe(ie,W){if(ce(W))throw Error("division by zero");if(ce(ie))return new Ae(X,X);if(Te(ie))return W=Pe(_e(ie),W),new Ae(_e(W.g),_e(W.h));if(Te(W))return W=Pe(ie,_e(W)),new Ae(_e(W.g),W.h);if(30<ie.g.length){if(Te(ie)||Te(W))throw Error("slowDivide_ only works with positive integers.");for(var ee=Z,ae=W;0>=ae.l(ie);)ee=Oe(ee),ae=Oe(ae);var oe=Ve(ee,1),ue=Ve(ae,1);for(ae=Ve(ae,2),ee=Ve(ee,2);!ce(ae);){var ne=ue.add(ae);0>=ne.l(ie)&&(oe=oe.add(ee),ue=ne),ae=Ve(ae,1),ee=Ve(ee,1)}return W=ve(ie,oe.j(W)),new Ae(oe,W)}for(oe=X;0<=ie.l(W);){for(ee=Math.max(1,Math.floor(ie.m()/W.m())),ae=Math.ceil(Math.log(ee)/Math.LN2),ae=48>=ae?1:Math.pow(2,ae-48),ue=g(ee),ne=ue.j(W);Te(ne)||0<ne.l(ie);)ee-=ae,ue=g(ee),ne=ue.j(W);ce(ue)&&(ue=Z),oe=oe.add(ue),ie=ve(ie,ne)}return new Ae(oe,ie)}r.A=function(ie){return Pe(this,ie).h},r.and=function(ie){for(var W=Math.max(this.g.length,ie.g.length),ee=[],ae=0;ae<W;ae++)ee[ae]=this.i(ae)&ie.i(ae);return new d(ee,this.h&ie.h)},r.or=function(ie){for(var W=Math.max(this.g.length,ie.g.length),ee=[],ae=0;ae<W;ae++)ee[ae]=this.i(ae)|ie.i(ae);return new d(ee,this.h|ie.h)},r.xor=function(ie){for(var W=Math.max(this.g.length,ie.g.length),ee=[],ae=0;ae<W;ae++)ee[ae]=this.i(ae)^ie.i(ae);return new d(ee,this.h^ie.h)};function Oe(ie){for(var W=ie.g.length+1,ee=[],ae=0;ae<W;ae++)ee[ae]=ie.i(ae)<<1|ie.i(ae-1)>>>31;return new d(ee,ie.h)}function Ve(ie,W){var ee=W>>5;W%=32;for(var ae=ie.g.length-ee,oe=[],ue=0;ue<ae;ue++)oe[ue]=0<W?ie.i(ue+ee)>>>W|ie.i(ue+ee+1)<<32-W:ie.i(ue+ee);return new d(oe,ie.h)}s.prototype.digest=s.prototype.v,s.prototype.reset=s.prototype.s,s.prototype.update=s.prototype.u,Md5=s,d.prototype.add=d.prototype.add,d.prototype.multiply=d.prototype.j,d.prototype.modulo=d.prototype.A,d.prototype.compare=d.prototype.l,d.prototype.toNumber=d.prototype.m,d.prototype.toString=d.prototype.toString,d.prototype.getBits=d.prototype.i,d.fromNumber=g,d.fromString=b,Integer=d}).apply(typeof commonjsGlobal$1<"u"?commonjsGlobal$1:typeof self<"u"?self:typeof window<"u"?window:{});var commonjsGlobal=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var XhrIo,WebChannel,EventType,ErrorCode,Stat,Event,getStatEventTarget,createWebChannelTransport;(function(){var r,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(c,y,v){return c==Array.prototype||c==Object.prototype||(c[y]=v.value),c};function n(c){c=[typeof globalThis=="object"&&globalThis,c,typeof window=="object"&&window,typeof self=="object"&&self,typeof commonjsGlobal=="object"&&commonjsGlobal];for(var y=0;y<c.length;++y){var v=c[y];if(v&&v.Math==Math)return v}throw Error("Cannot find global object")}var s=n(this);function o(c,y){if(y)e:{var v=s;c=c.split(".");for(var z=0;z<c.length-1;z++){var he=c[z];if(!(he in v))break e;v=v[he]}c=c[c.length-1],z=v[c],y=y(z),y!=z&&y!=null&&e(v,c,{configurable:!0,writable:!0,value:y})}}function u(c,y){c instanceof String&&(c+="");var v=0,z=!1,he={next:function(){if(!z&&v<c.length){var be=v++;return{value:y(be,c[be]),done:!1}}return z=!0,{done:!0,value:void 0}}};return he[Symbol.iterator]=function(){return he},he}o("Array.prototype.values",function(c){return c||function(){return u(this,function(y,v){return v})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var d=d||{},m=this||self;function p(c){var y=typeof c;return y=y!="object"?y:c?Array.isArray(c)?"array":y:"null",y=="array"||y=="object"&&typeof c.length=="number"}function g(c){var y=typeof c;return y=="object"&&c!=null||y=="function"}function b(c,y,v){return c.call.apply(c.bind,arguments)}function X(c,y,v){if(!c)throw Error();if(2<arguments.length){var z=Array.prototype.slice.call(arguments,2);return function(){var he=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(he,z),c.apply(y,he)}}return function(){return c.apply(y,arguments)}}function Z(c,y,v){return Z=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?b:X,Z.apply(null,arguments)}function fe(c,y){var v=Array.prototype.slice.call(arguments,1);return function(){var z=v.slice();return z.push.apply(z,arguments),c.apply(this,z)}}function ce(c,y){function v(){}v.prototype=y.prototype,c.aa=y.prototype,c.prototype=new v,c.prototype.constructor=c,c.Qb=function(z,he,be){for(var Ne=Array(arguments.length-2),Ke=2;Ke<arguments.length;Ke++)Ne[Ke-2]=arguments[Ke];return y.prototype[he].apply(z,Ne)}}function Te(c){const y=c.length;if(0<y){const v=Array(y);for(let z=0;z<y;z++)v[z]=c[z];return v}return[]}function _e(c,y){for(let v=1;v<arguments.length;v++){const z=arguments[v];if(p(z)){const he=c.length||0,be=z.length||0;c.length=he+be;for(let Ne=0;Ne<be;Ne++)c[he+Ne]=z[Ne]}else c.push(z)}}class ve{constructor(y,v){this.i=y,this.j=v,this.h=0,this.g=null}get(){let y;return 0<this.h?(this.h--,y=this.g,this.g=y.next,y.next=null):y=this.i(),y}}function Re(c){return/^[\s\xa0]*$/.test(c)}function Ae(){var c=m.navigator;return c&&(c=c.userAgent)?c:""}function Pe(c){return Pe[" "](c),c}Pe[" "]=function(){};var Oe=Ae().indexOf("Gecko")!=-1&&!(Ae().toLowerCase().indexOf("webkit")!=-1&&Ae().indexOf("Edge")==-1)&&!(Ae().indexOf("Trident")!=-1||Ae().indexOf("MSIE")!=-1)&&Ae().indexOf("Edge")==-1;function Ve(c,y,v){for(const z in c)y.call(v,c[z],z,c)}function ie(c,y){for(const v in c)y.call(void 0,c[v],v,c)}function W(c){const y={};for(const v in c)y[v]=c[v];return y}const ee="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function ae(c,y){let v,z;for(let he=1;he<arguments.length;he++){z=arguments[he];for(v in z)c[v]=z[v];for(let be=0;be<ee.length;be++)v=ee[be],Object.prototype.hasOwnProperty.call(z,v)&&(c[v]=z[v])}}function oe(c){var y=1;c=c.split(":");const v=[];for(;0<y&&c.length;)v.push(c.shift()),y--;return c.length&&v.push(c.join(":")),v}function ue(c){m.setTimeout(()=>{throw c},0)}function ne(){var c=We;let y=null;return c.g&&(y=c.g,c.g=c.g.next,c.g||(c.h=null),y.next=null),y}class mn{constructor(){this.h=this.g=null}add(y,v){const z=Mt.get();z.set(y,v),this.h?this.h.next=z:this.g=z,this.h=z}}var Mt=new ve(()=>new ge,c=>c.reset());class ge{constructor(){this.next=this.g=this.h=null}set(y,v){this.h=y,this.g=v,this.next=null}reset(){this.next=this.g=this.h=null}}let Ce,ke=!1,We=new mn,re=()=>{const c=m.Promise.resolve(void 0);Ce=()=>{c.then(Se)}};var Se=()=>{for(var c;c=ne();){try{c.h.call(c.g)}catch(v){ue(v)}var y=Mt;y.j(c),100>y.h&&(y.h++,c.next=y.g,y.g=c)}ke=!1};function De(){this.s=this.s,this.C=this.C}De.prototype.s=!1,De.prototype.ma=function(){this.s||(this.s=!0,this.N())},De.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function Ie(c,y){this.type=c,this.g=this.target=y,this.defaultPrevented=!1}Ie.prototype.h=function(){this.defaultPrevented=!0};var Le=(function(){if(!m.addEventListener||!Object.defineProperty)return!1;var c=!1,y=Object.defineProperty({},"passive",{get:function(){c=!0}});try{const v=()=>{};m.addEventListener("test",v,y),m.removeEventListener("test",v,y)}catch{}return c})();function Fe(c,y){if(Ie.call(this,c?c.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,c){var v=this.type=c.type,z=c.changedTouches&&c.changedTouches.length?c.changedTouches[0]:null;if(this.target=c.target||c.srcElement,this.g=y,y=c.relatedTarget){if(Oe){e:{try{Pe(y.nodeName);var he=!0;break e}catch{}he=!1}he||(y=null)}}else v=="mouseover"?y=c.fromElement:v=="mouseout"&&(y=c.toElement);this.relatedTarget=y,z?(this.clientX=z.clientX!==void 0?z.clientX:z.pageX,this.clientY=z.clientY!==void 0?z.clientY:z.pageY,this.screenX=z.screenX||0,this.screenY=z.screenY||0):(this.clientX=c.clientX!==void 0?c.clientX:c.pageX,this.clientY=c.clientY!==void 0?c.clientY:c.pageY,this.screenX=c.screenX||0,this.screenY=c.screenY||0),this.button=c.button,this.key=c.key||"",this.ctrlKey=c.ctrlKey,this.altKey=c.altKey,this.shiftKey=c.shiftKey,this.metaKey=c.metaKey,this.pointerId=c.pointerId||0,this.pointerType=typeof c.pointerType=="string"?c.pointerType:qe[c.pointerType]||"",this.state=c.state,this.i=c,c.defaultPrevented&&Fe.aa.h.call(this)}}ce(Fe,Ie);var qe={2:"touch",3:"pen",4:"mouse"};Fe.prototype.h=function(){Fe.aa.h.call(this);var c=this.i;c.preventDefault?c.preventDefault():c.returnValue=!1};var En="closure_listenable_"+(1e6*Math.random()|0),wt=0;function gr(c,y,v,z,he){this.listener=c,this.proxy=null,this.src=y,this.type=v,this.capture=!!z,this.ha=he,this.key=++wt,this.da=this.fa=!1}function si(c){c.da=!0,c.listener=null,c.proxy=null,c.src=null,c.ha=null}function Pr(c){this.src=c,this.g={},this.h=0}Pr.prototype.add=function(c,y,v,z,he){var be=c.toString();c=this.g[be],c||(c=this.g[be]=[],this.h++);var Ne=ki(c,y,z,he);return-1<Ne?(y=c[Ne],v||(y.fa=!1)):(y=new gr(y,this.src,be,!!z,he),y.fa=v,c.push(y)),y};function Mi(c,y){var v=y.type;if(v in c.g){var z=c.g[v],he=Array.prototype.indexOf.call(z,y,void 0),be;(be=0<=he)&&Array.prototype.splice.call(z,he,1),be&&(si(y),c.g[v].length==0&&(delete c.g[v],c.h--))}}function ki(c,y,v,z){for(var he=0;he<c.length;++he){var be=c[he];if(!be.da&&be.listener==y&&be.capture==!!v&&be.ha==z)return he}return-1}var ji="closure_lm_"+(1e6*Math.random()|0),ua={};function vo(c,y,v,z,he){if(Array.isArray(y)){for(var be=0;be<y.length;be++)vo(c,y[be],v,z,he);return null}return v=_o(v),c&&c[En]?c.K(y,v,g(z)?!!z.capture:!1,he):Wn(c,y,v,!1,z,he)}function Wn(c,y,v,z,he,be){if(!y)throw Error("Invalid event type");var Ne=g(he)?!!he.capture:!!he,Ke=vs(c);if(Ke||(c[ji]=Ke=new Pr(c)),v=Ke.add(y,v,z,Ne,be),v.proxy)return v;if(z=ql(),v.proxy=z,z.src=c,z.listener=v,c.addEventListener)Le||(he=Ne),he===void 0&&(he=!1),c.addEventListener(y.toString(),z,he);else if(c.attachEvent)c.attachEvent(Vi(y.toString()),z);else if(c.addListener&&c.removeListener)c.addListener(z);else throw Error("addEventListener and attachEvent are unavailable.");return v}function ql(){function c(v){return y.call(c.src,c.listener,v)}const y=Hl;return c}function ca(c,y,v,z,he){if(Array.isArray(y))for(var be=0;be<y.length;be++)ca(c,y[be],v,z,he);else z=g(z)?!!z.capture:!!z,v=_o(v),c&&c[En]?(c=c.i,y=String(y).toString(),y in c.g&&(be=c.g[y],v=ki(be,v,z,he),-1<v&&(si(be[v]),Array.prototype.splice.call(be,v,1),be.length==0&&(delete c.g[y],c.h--)))):c&&(c=vs(c))&&(y=c.g[y.toString()],c=-1,y&&(c=ki(y,v,z,he)),(v=-1<c?y[c]:null)&&ys(v))}function ys(c){if(typeof c!="number"&&c&&!c.da){var y=c.src;if(y&&y[En])Mi(y.i,c);else{var v=c.type,z=c.proxy;y.removeEventListener?y.removeEventListener(v,z,c.capture):y.detachEvent?y.detachEvent(Vi(v),z):y.addListener&&y.removeListener&&y.removeListener(z),(v=vs(y))?(Mi(v,c),v.h==0&&(v.src=null,y[ji]=null)):si(c)}}}function Vi(c){return c in ua?ua[c]:ua[c]="on"+c}function Hl(c,y){if(c.da)c=!0;else{y=new Fe(y,this);var v=c.listener,z=c.ha||c.src;c.fa&&ys(c),c=v.call(z,y)}return c}function vs(c){return c=c[ji],c instanceof Pr?c:null}var ha="__closure_events_fn_"+(1e9*Math.random()>>>0);function _o(c){return typeof c=="function"?c:(c[ha]||(c[ha]=function(y){return c.handleEvent(y)}),c[ha])}function zt(){De.call(this),this.i=new Pr(this),this.M=this,this.F=null}ce(zt,De),zt.prototype[En]=!0,zt.prototype.removeEventListener=function(c,y,v,z){ca(this,c,y,v,z)};function tt(c,y){var v,z=c.F;if(z)for(v=[];z;z=z.F)v.push(z);if(c=c.M,z=y.type||y,typeof y=="string")y=new Ie(y,c);else if(y instanceof Ie)y.target=y.target||c;else{var he=y;y=new Ie(z,c),ae(y,he)}if(he=!0,v)for(var be=v.length-1;0<=be;be--){var Ne=y.g=v[be];he=qn(Ne,z,!0,y)&&he}if(Ne=y.g=c,he=qn(Ne,z,!0,y)&&he,he=qn(Ne,z,!1,y)&&he,v)for(be=0;be<v.length;be++)Ne=y.g=v[be],he=qn(Ne,z,!1,y)&&he}zt.prototype.N=function(){if(zt.aa.N.call(this),this.i){var c=this.i,y;for(y in c.g){for(var v=c.g[y],z=0;z<v.length;z++)si(v[z]);delete c.g[y],c.h--}}this.F=null},zt.prototype.K=function(c,y,v,z){return this.i.add(String(c),y,!1,v,z)},zt.prototype.L=function(c,y,v,z){return this.i.add(String(c),y,!0,v,z)};function qn(c,y,v,z){if(y=c.i.g[String(y)],!y)return!0;y=y.concat();for(var he=!0,be=0;be<y.length;++be){var Ne=y[be];if(Ne&&!Ne.da&&Ne.capture==v){var Ke=Ne.listener,gn=Ne.ha||Ne.src;Ne.fa&&Mi(c.i,Ne),he=Ke.call(gn,z)!==!1&&he}}return he&&!z.defaultPrevented}function On(c,y,v){if(typeof c=="function")v&&(c=Z(c,v));else if(c&&typeof c.handleEvent=="function")c=Z(c.handleEvent,c);else throw Error("Invalid listener argument");return 2147483647<Number(y)?-1:m.setTimeout(c,y||0)}function bo(c){c.g=On(()=>{c.g=null,c.i&&(c.i=!1,bo(c))},c.l);const y=c.h;c.h=null,c.m.apply(null,y)}class Fl extends De{constructor(y,v){super(),this.m=y,this.l=v,this.h=null,this.i=!1,this.g=null}j(y){this.h=arguments,this.g?this.i=!0:bo(this)}N(){super.N(),this.g&&(m.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Li(c){De.call(this),this.h=c,this.g={}}ce(Li,De);var Ui=[];function Bi(c){Ve(c.g,function(y,v){this.g.hasOwnProperty(v)&&ys(y)},c),c.g={}}Li.prototype.N=function(){Li.aa.N.call(this),Bi(this)},Li.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var cr=m.JSON.stringify,_s=m.JSON.parse,zi=class{stringify(c){return m.JSON.stringify(c,void 0)}parse(c){return m.JSON.parse(c,void 0)}};function da(){}da.prototype.h=null;function fa(c){return c.h||(c.h=c.i())}function ma(){}var Mr={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function kr(){Ie.call(this,"d")}ce(kr,Ie);function pa(){Ie.call(this,"c")}ce(pa,Ie);var yr={},ga=null;function ai(){return ga=ga||new zt}yr.La="serverreachability";function bs(c){Ie.call(this,yr.La,c)}ce(bs,Ie);function oi(c){const y=ai();tt(y,new bs(y))}yr.STAT_EVENT="statevent";function Eo(c,y){Ie.call(this,yr.STAT_EVENT,c),this.stat=y}ce(Eo,Ie);function kt(c){const y=ai();tt(y,new Eo(y,c))}yr.Ma="timingevent";function pn(c,y){Ie.call(this,yr.Ma,c),this.size=y}ce(pn,Ie);function Wt(c,y){if(typeof c!="function")throw Error("Fn must not be null and must be a function");return m.setTimeout(function(){c()},y)}function Zn(){this.g=!0}Zn.prototype.xa=function(){this.g=!1};function ya(c,y,v,z,he,be){c.info(function(){if(c.g)if(be)for(var Ne="",Ke=be.split("&"),gn=0;gn<Ke.length;gn++){var Qe=Ke[gn].split("=");if(1<Qe.length){var Tn=Qe[0];Qe=Qe[1];var yn=Tn.split("_");Ne=2<=yn.length&&yn[1]=="type"?Ne+(Tn+"="+Qe+"&"):Ne+(Tn+"=redacted&")}}else Ne=null;else Ne=be;return"XMLHTTP REQ ("+z+") [attempt "+he+"]: "+y+`
`+v+`
`+Ne})}function Gl(c,y,v,z,he,be,Ne){c.info(function(){return"XMLHTTP RESP ("+z+") [ attempt "+he+"]: "+y+`
`+v+`
`+be+" "+Ne})}function li(c,y,v,z){c.info(function(){return"XMLHTTP TEXT ("+y+"): "+qi(c,v)+(z?" "+z:"")})}function wo(c,y){c.info(function(){return"TIMEOUT: "+y})}Zn.prototype.info=function(){};function qi(c,y){if(!c.g)return y;if(!y)return null;try{var v=JSON.parse(y);if(v){for(c=0;c<v.length;c++)if(Array.isArray(v[c])){var z=v[c];if(!(2>z.length)){var he=z[1];if(Array.isArray(he)&&!(1>he.length)){var be=he[0];if(be!="noop"&&be!="stop"&&be!="close")for(var Ne=1;Ne<he.length;Ne++)he[Ne]=""}}}}return cr(v)}catch{return y}}var ui={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},jr={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},vr;function _r(){}ce(_r,da),_r.prototype.g=function(){return new XMLHttpRequest},_r.prototype.i=function(){return{}},vr=new _r;function kn(c,y,v,z){this.j=c,this.i=y,this.l=v,this.R=z||1,this.U=new Li(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Gt}function Gt(){this.i=null,this.g="",this.h=!1}var va={},Es={};function hr(c,y,v){c.L=1,c.v=Yi(Hn(y)),c.m=v,c.P=!0,Vr(c,null)}function Vr(c,y){c.F=Date.now(),Hi(c),c.A=Hn(c.v);var v=c.A,z=c.R;Array.isArray(z)||(z=[String(z)]),xa(v.i,"t",z),c.C=0,v=c.j.J,c.h=new Gt,c.g=Lo(c.j,v?y:null,!c.m),0<c.O&&(c.M=new Fl(Z(c.Y,c,c.g),c.O)),y=c.U,v=c.g,z=c.ca;var he="readystatechange";Array.isArray(he)||(he&&(Ui[0]=he.toString()),he=Ui);for(var be=0;be<he.length;be++){var Ne=vo(v,he[be],z||y.handleEvent,!1,y.h||y);if(!Ne)break;y.g[Ne.key]=Ne}y=c.H?W(c.H):{},c.m?(c.u||(c.u="POST"),y["Content-Type"]="application/x-www-form-urlencoded",c.g.ea(c.A,c.u,c.m,y)):(c.u="GET",c.g.ea(c.A,c.u,null,y)),oi(),ya(c.i,c.u,c.A,c.l,c.R,c.m)}kn.prototype.ca=function(c){c=c.target;const y=this.M;y&&nr(c)==3?y.j():this.Y(c)},kn.prototype.Y=function(c){try{if(c==this.g)e:{const yn=nr(this.g);var y=this.g.Ba();const Gr=this.g.Z();if(!(3>yn)&&(yn!=3||this.g&&(this.h.h||this.g.oa()||No(this.g)))){this.J||yn!=4||y==7||(y==8||0>=Gr?oi(3):oi(2)),ci(this);var v=this.g.Z();this.X=v;t:if(To(this)){var z=No(this.g);c="";var he=z.length,be=nr(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){Rn(this),br(this);var Ne="";break t}this.h.i=new m.TextDecoder}for(y=0;y<he;y++)this.h.h=!0,c+=this.h.i.decode(z[y],{stream:!(be&&y==he-1)});z.length=0,this.h.g+=c,this.C=0,Ne=this.h.g}else Ne=this.g.oa();if(this.o=v==200,Gl(this.i,this.u,this.A,this.l,this.R,yn,v),this.o){if(this.T&&!this.K){t:{if(this.g){var Ke,gn=this.g;if((Ke=gn.g?gn.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!Re(Ke)){var Qe=Ke;break t}}Qe=null}if(v=Qe)li(this.i,this.l,v,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Fi(this,v);else{this.o=!1,this.s=3,kt(12),Rn(this),br(this);break e}}if(this.P){v=!0;let Cn;for(;!this.J&&this.C<Ne.length;)if(Cn=xo(this,Ne),Cn==Es){yn==4&&(this.s=4,kt(14),v=!1),li(this.i,this.l,null,"[Incomplete Response]");break}else if(Cn==va){this.s=4,kt(15),li(this.i,this.l,Ne,"[Invalid Chunk]"),v=!1;break}else li(this.i,this.l,Cn,null),Fi(this,Cn);if(To(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),yn!=4||Ne.length!=0||this.h.h||(this.s=1,kt(16),v=!1),this.o=this.o&&v,!v)li(this.i,this.l,Ne,"[Invalid Chunked Response]"),Rn(this),br(this);else if(0<Ne.length&&!this.W){this.W=!0;var Tn=this.j;Tn.g==this&&Tn.ba&&!Tn.M&&(Tn.j.info("Great, no buffering proxy detected. Bytes received: "+Ne.length),ts(Tn),Tn.M=!0,kt(11))}}else li(this.i,this.l,Ne,null),Fi(this,Ne);yn==4&&Rn(this),this.o&&!this.J&&(yn==4?ko(this.j,this):(this.o=!1,Hi(this)))}else Xl(this.g),v==400&&0<Ne.indexOf("Unknown SID")?(this.s=3,kt(12)):(this.s=0,kt(13)),Rn(this),br(this)}}}catch{}finally{}};function To(c){return c.g?c.u=="GET"&&c.L!=2&&c.j.Ca:!1}function xo(c,y){var v=c.C,z=y.indexOf(`
`,v);return z==-1?Es:(v=Number(y.substring(v,z)),isNaN(v)?va:(z+=1,z+v>y.length?Es:(y=y.slice(z,z+v),c.C=z+v,y)))}kn.prototype.cancel=function(){this.J=!0,Rn(this)};function Hi(c){c.S=Date.now()+c.I,So(c,c.I)}function So(c,y){if(c.B!=null)throw Error("WatchDog timer not null");c.B=Wt(Z(c.ba,c),y)}function ci(c){c.B&&(m.clearTimeout(c.B),c.B=null)}kn.prototype.ba=function(){this.B=null;const c=Date.now();0<=c-this.S?(wo(this.i,this.A),this.L!=2&&(oi(),kt(17)),Rn(this),this.s=2,br(this)):So(this,this.S-c)};function br(c){c.j.G==0||c.J||ko(c.j,c)}function Rn(c){ci(c);var y=c.M;y&&typeof y.ma=="function"&&y.ma(),c.M=null,Bi(c.U),c.g&&(y=c.g,c.g=null,y.abort(),y.ma())}function Fi(c,y){try{var v=c.j;if(v.G!=0&&(v.g==c||_a(v.h,c))){if(!c.K&&_a(v.h,c)&&v.G==3){try{var z=v.Da.g.parse(y)}catch{z=null}if(Array.isArray(z)&&z.length==3){var he=z;if(he[0]==0){e:if(!v.u){if(v.g)if(v.g.F+3e3<c.F)Ps(v),Ds(v);else break e;Ia(v),kt(18)}}else v.za=he[1],0<v.za-v.T&&37500>he[2]&&v.F&&v.v==0&&!v.C&&(v.C=Wt(Z(v.Za,v),6e3));if(1>=Ts(v.h)&&v.ca){try{v.ca()}catch{}v.ca=void 0}}else Fr(v,11)}else if((c.K||v.g==c)&&Ps(v),!Re(y))for(he=v.Da.g.parse(y),y=0;y<he.length;y++){let Qe=he[y];if(v.T=Qe[0],Qe=Qe[1],v.G==2)if(Qe[0]=="c"){v.K=Qe[1],v.ia=Qe[2];const Tn=Qe[3];Tn!=null&&(v.la=Tn,v.j.info("VER="+v.la));const yn=Qe[4];yn!=null&&(v.Aa=yn,v.j.info("SVER="+v.Aa));const Gr=Qe[5];Gr!=null&&typeof Gr=="number"&&0<Gr&&(z=1.5*Gr,v.L=z,v.j.info("backChannelRequestTimeoutMs_="+z)),z=v;const Cn=c.g;if(Cn){const Rr=Cn.g?Cn.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Rr){var be=z.h;be.g||Rr.indexOf("spdy")==-1&&Rr.indexOf("quic")==-1&&Rr.indexOf("h2")==-1||(be.j=be.l,be.g=new Set,be.h&&(xs(be,be.h),be.h=null))}if(z.D){const Da=Cn.g?Cn.g.getResponseHeader("X-HTTP-Session-Id"):null;Da&&(z.ya=Da,it(z.I,z.D,Da))}}v.G=3,v.l&&v.l.ua(),v.ba&&(v.R=Date.now()-c.F,v.j.info("Handshake RTT: "+v.R+"ms")),z=v;var Ne=c;if(z.qa=Vo(z,z.J?z.ia:null,z.W),Ne.K){jn(z.h,Ne);var Ke=Ne,gn=z.L;gn&&(Ke.I=gn),Ke.B&&(ci(Ke),Hi(Ke)),z.g=Ne}else Po(z);0<v.i.length&&Os(v)}else Qe[0]!="stop"&&Qe[0]!="close"||Fr(v,7);else v.G==3&&(Qe[0]=="stop"||Qe[0]=="close"?Qe[0]=="stop"?Fr(v,7):Ra(v):Qe[0]!="noop"&&v.l&&v.l.ta(Qe),v.v=0)}}oi(4)}catch{}}var Ao=class{constructor(c,y){this.g=c,this.map=y}};function Lr(c){this.l=c||10,m.PerformanceNavigationTiming?(c=m.performance.getEntriesByType("navigation"),c=0<c.length&&(c[0].nextHopProtocol=="hq"||c[0].nextHopProtocol=="h2")):c=!!(m.chrome&&m.chrome.loadTimes&&m.chrome.loadTimes()&&m.chrome.loadTimes().wasFetchedViaSpdy),this.j=c?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function ws(c){return c.h?!0:c.g?c.g.size>=c.j:!1}function Ts(c){return c.h?1:c.g?c.g.size:0}function _a(c,y){return c.h?c.h==y:c.g?c.g.has(y):!1}function xs(c,y){c.g?c.g.add(y):c.h=y}function jn(c,y){c.h&&c.h==y?c.h=null:c.g&&c.g.has(y)&&c.g.delete(y)}Lr.prototype.cancel=function(){if(this.i=ba(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const c of this.g.values())c.cancel();this.g.clear()}};function ba(c){if(c.h!=null)return c.i.concat(c.h.D);if(c.g!=null&&c.g.size!==0){let y=c.i;for(const v of c.g.values())y=y.concat(v.D);return y}return Te(c.i)}function $l(c){if(c.V&&typeof c.V=="function")return c.V();if(typeof Map<"u"&&c instanceof Map||typeof Set<"u"&&c instanceof Set)return Array.from(c.values());if(typeof c=="string")return c.split("");if(p(c)){for(var y=[],v=c.length,z=0;z<v;z++)y.push(c[z]);return y}y=[],v=0;for(z in c)y[v++]=c[z];return y}function Ss(c){if(c.na&&typeof c.na=="function")return c.na();if(!c.V||typeof c.V!="function"){if(typeof Map<"u"&&c instanceof Map)return Array.from(c.keys());if(!(typeof Set<"u"&&c instanceof Set)){if(p(c)||typeof c=="string"){var y=[];c=c.length;for(var v=0;v<c;v++)y.push(v);return y}y=[],v=0;for(const z in c)y[v++]=z;return y}}}function Ea(c,y){if(c.forEach&&typeof c.forEach=="function")c.forEach(y,void 0);else if(p(c)||typeof c=="string")Array.prototype.forEach.call(c,y,void 0);else for(var v=Ss(c),z=$l(c),he=z.length,be=0;be<he;be++)y.call(void 0,z[be],v&&v[be],c)}var Gi=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Yl(c,y){if(c){c=c.split("&");for(var v=0;v<c.length;v++){var z=c[v].indexOf("="),he=null;if(0<=z){var be=c[v].substring(0,z);he=c[v].substring(z+1)}else be=c[v];y(be,he?decodeURIComponent(he.replace(/\+/g," ")):"")}}}function ln(c){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,c instanceof ln){this.h=c.h,$i(this,c.j),this.o=c.o,this.g=c.g,hi(this,c.s),this.l=c.l;var y=c.i,v=new Br;v.i=y.i,y.g&&(v.g=new Map(y.g),v.h=y.h),Ur(this,v),this.m=c.m}else c&&(y=String(c).match(Gi))?(this.h=!1,$i(this,y[1]||"",!0),this.o=Jn(y[2]||""),this.g=Jn(y[3]||"",!0),hi(this,y[4]),this.l=Jn(y[5]||"",!0),Ur(this,y[6]||"",!0),this.m=Jn(y[7]||"")):(this.h=!1,this.i=new Br(null,this.h))}ln.prototype.toString=function(){var c=[],y=this.j;y&&c.push(Ki(y,wa,!0),":");var v=this.g;return(v||y=="file")&&(c.push("//"),(y=this.o)&&c.push(Ki(y,wa,!0),"@"),c.push(encodeURIComponent(String(v)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),v=this.s,v!=null&&c.push(":",String(v))),(v=this.l)&&(this.g&&v.charAt(0)!="/"&&c.push("/"),c.push(Ki(v,v.charAt(0)=="/"?Kl:Ta,!0))),(v=this.i.toString())&&c.push("?",v),(v=this.m)&&c.push("#",Ki(v,As)),c.join("")};function Hn(c){return new ln(c)}function $i(c,y,v){c.j=v?Jn(y,!0):y,c.j&&(c.j=c.j.replace(/:$/,""))}function hi(c,y){if(y){if(y=Number(y),isNaN(y)||0>y)throw Error("Bad port number "+y);c.s=y}else c.s=null}function Ur(c,y,v){y instanceof Br?(c.i=y,Co(c.i,c.h)):(v||(y=Ki(y,Ql)),c.i=new Br(y,c.h))}function it(c,y,v){c.i.set(y,v)}function Yi(c){return it(c,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),c}function Jn(c,y){return c?y?decodeURI(c.replace(/%25/g,"%2525")):decodeURIComponent(c):""}function Ki(c,y,v){return typeof c=="string"?(c=encodeURI(c).replace(y,Ro),v&&(c=c.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),c):null}function Ro(c){return c=c.charCodeAt(0),"%"+(c>>4&15).toString(16)+(c&15).toString(16)}var wa=/[#\/\?@]/g,Ta=/[#\?:]/g,Kl=/[#\?]/g,Ql=/[#\?@]/g,As=/#/g;function Br(c,y){this.h=this.g=null,this.i=c||null,this.j=!!y}function er(c){c.g||(c.g=new Map,c.h=0,c.i&&Yl(c.i,function(y,v){c.add(decodeURIComponent(y.replace(/\+/g," ")),v)}))}r=Br.prototype,r.add=function(c,y){er(this),this.i=null,c=Er(this,c);var v=this.g.get(c);return v||this.g.set(c,v=[]),v.push(y),this.h+=1,this};function zr(c,y){er(c),y=Er(c,y),c.g.has(y)&&(c.i=null,c.h-=c.g.get(y).length,c.g.delete(y))}function qr(c,y){return er(c),y=Er(c,y),c.g.has(y)}r.forEach=function(c,y){er(this),this.g.forEach(function(v,z){v.forEach(function(he){c.call(y,he,z,this)},this)},this)},r.na=function(){er(this);const c=Array.from(this.g.values()),y=Array.from(this.g.keys()),v=[];for(let z=0;z<y.length;z++){const he=c[z];for(let be=0;be<he.length;be++)v.push(y[z])}return v},r.V=function(c){er(this);let y=[];if(typeof c=="string")qr(this,c)&&(y=y.concat(this.g.get(Er(this,c))));else{c=Array.from(this.g.values());for(let v=0;v<c.length;v++)y=y.concat(c[v])}return y},r.set=function(c,y){return er(this),this.i=null,c=Er(this,c),qr(this,c)&&(this.h-=this.g.get(c).length),this.g.set(c,[y]),this.h+=1,this},r.get=function(c,y){return c?(c=this.V(c),0<c.length?String(c[0]):y):y};function xa(c,y,v){zr(c,y),0<v.length&&(c.i=null,c.g.set(Er(c,y),Te(v)),c.h+=v.length)}r.toString=function(){if(this.i)return this.i;if(!this.g)return"";const c=[],y=Array.from(this.g.keys());for(var v=0;v<y.length;v++){var z=y[v];const be=encodeURIComponent(String(z)),Ne=this.V(z);for(z=0;z<Ne.length;z++){var he=be;Ne[z]!==""&&(he+="="+encodeURIComponent(String(Ne[z]))),c.push(he)}}return this.i=c.join("&")};function Er(c,y){return y=String(y),c.j&&(y=y.toLowerCase()),y}function Co(c,y){y&&!c.j&&(er(c),c.i=null,c.g.forEach(function(v,z){var he=z.toLowerCase();z!=he&&(zr(this,z),xa(this,he,v))},c)),c.j=y}function Qi(c,y){const v=new Zn;if(m.Image){const z=new Image;z.onload=fe(tr,v,"TestLoadImage: loaded",!0,y,z),z.onerror=fe(tr,v,"TestLoadImage: error",!1,y,z),z.onabort=fe(tr,v,"TestLoadImage: abort",!1,y,z),z.ontimeout=fe(tr,v,"TestLoadImage: timeout",!1,y,z),m.setTimeout(function(){z.ontimeout&&z.ontimeout()},1e4),z.src=c}else y(!1)}function dr(c,y){const v=new Zn,z=new AbortController,he=setTimeout(()=>{z.abort(),tr(v,"TestPingServer: timeout",!1,y)},1e4);fetch(c,{signal:z.signal}).then(be=>{clearTimeout(he),be.ok?tr(v,"TestPingServer: ok",!0,y):tr(v,"TestPingServer: server error",!1,y)}).catch(()=>{clearTimeout(he),tr(v,"TestPingServer: error",!1,y)})}function tr(c,y,v,z,he){try{he&&(he.onload=null,he.onerror=null,he.onabort=null,he.ontimeout=null),z(v)}catch{}}function Xi(){this.g=new zi}function wr(c,y,v){const z=v||"";try{Ea(c,function(he,be){let Ne=he;g(he)&&(Ne=cr(he)),y.push(z+be+"="+encodeURIComponent(Ne))})}catch(he){throw y.push(z+"type="+encodeURIComponent("_badmap")),he}}function di(c){this.l=c.Ub||null,this.j=c.eb||!1}ce(di,da),di.prototype.g=function(){return new Hr(this.l,this.j)},di.prototype.i=(function(c){return function(){return c}})({});function Hr(c,y){zt.call(this),this.D=c,this.o=y,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}ce(Hr,zt),r=Hr.prototype,r.open=function(c,y){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=c,this.A=y,this.readyState=1,xr(this)},r.send=function(c){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const y={headers:this.u,method:this.B,credentials:this.m,cache:void 0};c&&(y.body=c),(this.D||m).fetch(new Request(this.A,y)).then(this.Sa.bind(this),this.ga.bind(this))},r.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Tr(this)),this.readyState=0},r.Sa=function(c){if(this.g&&(this.l=c,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=c.headers,this.readyState=2,xr(this)),this.g&&(this.readyState=3,xr(this),this.g)))if(this.responseType==="arraybuffer")c.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof m.ReadableStream<"u"&&"body"in c){if(this.j=c.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Sa(this)}else c.text().then(this.Ra.bind(this),this.ga.bind(this))};function Sa(c){c.j.read().then(c.Pa.bind(c)).catch(c.ga.bind(c))}r.Pa=function(c){if(this.g){if(this.o&&c.value)this.response.push(c.value);else if(!this.o){var y=c.value?c.value:new Uint8Array(0);(y=this.v.decode(y,{stream:!c.done}))&&(this.response=this.responseText+=y)}c.done?Tr(this):xr(this),this.readyState==3&&Sa(this)}},r.Ra=function(c){this.g&&(this.response=this.responseText=c,Tr(this))},r.Qa=function(c){this.g&&(this.response=c,Tr(this))},r.ga=function(){this.g&&Tr(this)};function Tr(c){c.readyState=4,c.l=null,c.j=null,c.v=null,xr(c)}r.setRequestHeader=function(c,y){this.u.append(c,y)},r.getResponseHeader=function(c){return this.h&&this.h.get(c.toLowerCase())||""},r.getAllResponseHeaders=function(){if(!this.h)return"";const c=[],y=this.h.entries();for(var v=y.next();!v.done;)v=v.value,c.push(v[0]+": "+v[1]),v=y.next();return c.join(`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xt="WebChannelConnection";class __PRIVATE_WebChannelConnection extends __PRIVATE_RestConnection{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,n,s,o,u){const d=__PRIVATE_generateUniqueDebugId();return new Promise(((m,p)=>{const g=new XhrIo;g.setWithCredentials(!0),g.listenOnce(EventType.COMPLETE,(()=>{try{switch(g.getLastErrorCode()){case ErrorCode.NO_ERROR:const X=g.getResponseJson();__PRIVATE_logDebug(Xt,`XHR for RPC '${e}' ${d} received:`,JSON.stringify(X)),m(X);break;case ErrorCode.TIMEOUT:__PRIVATE_logDebug(Xt,`RPC '${e}' ${d} timed out`),p(new FirestoreError(N$1.DEADLINE_EXCEEDED,"Request time out"));break;case ErrorCode.HTTP_ERROR:const Z=g.getStatus();if(__PRIVATE_logDebug(Xt,`RPC '${e}' ${d} failed with status:`,Z,"response text:",g.getResponseText()),Z>0){let fe=g.getResponseJson();Array.isArray(fe)&&(fe=fe[0]);const ce=fe?.error;if(ce&&ce.status&&ce.message){const Te=(function(ve){const Re=ve.toLowerCase().replace(/_/g,"-");return Object.values(N$1).indexOf(Re)>=0?Re:N$1.UNKNOWN})(ce.status);p(new FirestoreError(Te,ce.message))}else p(new FirestoreError(N$1.UNKNOWN,"Server responded with status "+g.getStatus()))}else p(new FirestoreError(N$1.UNAVAILABLE,"Connection failed."));break;default:fail(9055,{l_:e,streamId:d,h_:g.getLastErrorCode(),P_:g.getLastError()})}}finally{__PRIVATE_logDebug(Xt,`RPC '${e}' ${d} completed.`)}}));const b=JSON.stringify(o);__PRIVATE_logDebug(Xt,`RPC '${e}' ${d} sending request:`,o),g.send(n,"POST",b,s,15)}))}T_(e,n,s){const o=__PRIVATE_generateUniqueDebugId(),u=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],d=createWebChannelTransport(),m=getStatEventTarget(),p={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},g=this.longPollingOptions.timeoutSeconds;g!==void 0&&(p.longPollingTimeout=Math.round(1e3*g)),this.useFetchStreams&&(p.useFetchStreams=!0),this.jo(p.initMessageHeaders,n,s),p.encodeInitMessageHeaders=!0;const b=u.join("");__PRIVATE_logDebug(Xt,`Creating RPC '${e}' stream ${o}: ${b}`,p);const X=d.createWebChannel(b,p);this.I_(X);let Z=!1,fe=!1;const ce=new __PRIVATE_StreamBridge({Yo:_e=>{fe?__PRIVATE_logDebug(Xt,`Not sending because RPC '${e}' stream ${o} is closed:`,_e):(Z||(__PRIVATE_logDebug(Xt,`Opening RPC '${e}' stream ${o} transport.`),X.open(),Z=!0),__PRIVATE_logDebug(Xt,`RPC '${e}' stream ${o} sending:`,_e),X.send(_e))},Zo:()=>X.close()}),Te=(_e,ve,Re)=>{_e.listen(ve,(Ae=>{try{Re(Ae)}catch(Pe){setTimeout((()=>{throw Pe}),0)}}))};return Te(X,WebChannel.EventType.OPEN,(()=>{fe||(__PRIVATE_logDebug(Xt,`RPC '${e}' stream ${o} transport opened.`),ce.o_())})),Te(X,WebChannel.EventType.CLOSE,(()=>{fe||(fe=!0,__PRIVATE_logDebug(Xt,`RPC '${e}' stream ${o} transport closed`),ce.a_(),this.E_(X))})),Te(X,WebChannel.EventType.ERROR,(_e=>{fe||(fe=!0,__PRIVATE_logWarn(Xt,`RPC '${e}' stream ${o} transport errored. Name:`,_e.name,"Message:",_e.message),ce.a_(new FirestoreError(N$1.UNAVAILABLE,"The operation could not be completed")))})),Te(X,WebChannel.EventType.MESSAGE,(_e=>{if(!fe){const ve=_e.data[0];__PRIVATE_hardAssert(!!ve,16349);const Re=ve,Ae=Re?.error||Re[0]?.error;if(Ae){__PRIVATE_logDebug(Xt,`RPC '${e}' stream ${o} received error:`,Ae);const Pe=Ae.status;let Oe=(function(W){const ee=pt[W];if(ee!==void 0)return __PRIVATE_mapCodeFromRpcCode(ee)})(Pe),Ve=Ae.message;Oe===void 0&&(Oe=N$1.INTERNAL,Ve="Unknown error status: "+Pe+" with message "+Ae.message),fe=!0,ce.a_(new FirestoreError(Oe,Ve)),X.close()}else __PRIVATE_logDebug(Xt,`RPC '${e}' stream ${o} received:`,ve),ce.u_(ve)}})),Te(m,Event.STAT_EVENT,(_e=>{_e.stat===Stat.PROXY?__PRIVATE_logDebug(Xt,`RPC '${e}' stream ${o} detected buffering proxy`):_e.stat===Stat.NOPROXY&&__PRIVATE_logDebug(Xt,`RPC '${e}' stream ${o} detected no buffering proxy`)})),setTimeout((()=>{ce.__()}),0),ce}terminate(){this.c_.forEach((e=>e.close())),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter((n=>n===e))}}function getDocument(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sender{constructor(e){this.target=e,this.handlers=new Set}removeMessageHandler(e){e.messageChannel&&(e.messageChannel.port1.removeEventListener("message",e.onMessage),e.messageChannel.port1.close()),this.handlers.delete(e)}async _send(e,n,s=50){const o=typeof MessageChannel<"u"?new MessageChannel:null;if(!o)throw new Error("connection_unavailable");let u,d;return new Promise((m,p)=>{const g=_generateEventId("",20);o.port1.start();const b=setTimeout(()=>{p(new Error("unsupported_event"))},s);d={messageChannel:o,onMessage(X){const Z=X;if(Z.data.eventId===g)switch(Z.data.status){case"ack":clearTimeout(b),u=setTimeout(()=>{p(new Error("timeout"))},3e3);break;case"done":clearTimeout(u),m(Z.data.response);break;default:clearTimeout(b),clearTimeout(u),p(new Error("invalid_response"));break}}},this.handlers.add(d),o.port1.addEventListener("message",d.onMessage),this.target.postMessage({eventType:e,eventId:g,data:n},[o.port2])}).finally(()=>{d&&this.removeMessageHandler(d)})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const DEFAULT_ID_TOKEN_MAX_AGE=300,authIdTokenMaxAge=getExperimentalSetting("authIdTokenMaxAge")||DEFAULT_ID_TOKEN_MAX_AGE;let lastPostedIdToken=null;const mintCookieFactory=r=>async e=>{const n=e&&await e.getIdTokenResult(),s=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(s&&s>authIdTokenMaxAge)return;const o=n?.token;lastPostedIdToken!==o&&(lastPostedIdToken=o,await fetch(r,{method:o?"POST":"DELETE",headers:o?{Authorization:`Bearer ${o}`}:{}}))};function getAuth(r=getApp()){const e=_getProvider(r,"auth");if(e.isInitialized())return e.getImmediate();const n=initializeAuth(r,{popupRedirectResolver:browserPopupRedirectResolver,persistence:[indexedDBLocalPersistence,browserLocalPersistence,browserSessionPersistence]}),s=getExperimentalSetting("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const u=new URL(s,location.origin);if(location.origin===u.origin){const d=mintCookieFactory(u.toString());beforeAuthStateChanged(n,d,()=>d(n.currentUser)),onIdTokenChanged(n,m=>d(m))}}const o=getDefaultEmulatorHost("auth");return o&&connectAuthEmulator(n,`http://${o}`),n}function getScriptParentElement(){return document.getElementsByTagName("head")?.[0]??document}_setExternalJSProvider({loadJS(r){return new Promise((e,n)=>{const s=document.createElement("script");s.setAttribute("src",r),s.onload=e,s.onerror=o=>{const u=_createError("internal-error");u.customData=o,n(u)},s.type="text/javascript",s.charset="UTF-8",getScriptParentElement().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="}),registerAuth("Browser");const firebaseConfig={apiKey:"AIzaSyDE-JUYyO8IfwcQTkpKSk672lNPfOWEGPo",authDomain:"youoffice-814d4.firebaseapp.com",projectId:"youoffice-814d4",storageBucket:"youoffice-814d4.firebasestorage.app",messagingSenderId:"698200688802",appId:"1:698200688802:web:8414e5f9f791687c98effb",measurementId:"G-XR17DSBWK1"},app=initializeApp(firebaseConfig);getAnalytics(app);const db=getFirestore(app),auth=getAuth(app),ProductsContext=reactExports.createContext();function ProductsProvider({children:r}){const[e,n]=reactExports.useState([]),[s,o]=reactExports.useState(!0),u=async m=>{o(!0);try{const p=query(collection(db,"products"),where("category","==",m)),b=(await getDocs(p)).docs.map(X=>({id:X.id,...X.data()}));n(b)}catch(p){console.error("Error fetching products:",p)}finally{o(!1)}},d=async(m,p,g=4)=>{if(!m)return[];try{const b=query(collection(db,"products"),where("category","==",m),where(documentId(),"!=",p),limit(g));return(await getDocs(b)).docs.map(fe=>({id:fe.id,...fe.data()}))}catch(b){return console.error("Error fetching recommended products:",b),[]}};return jsxRuntimeExports.jsx(ProductsContext.Provider,{value:{products:e,loading:s,fetchProducts:u,fetchRecommendedProducts:d},children:r})}class AuthService{static async register(e,n,s){try{const o=await createUserWithEmailAndPassword(auth,e,n);return await updateProfile(o.user,{displayName:s}),{success:!0,user:o.user}}catch(o){return{success:!1,error:o.message}}}static async login(e,n){try{return{success:!0,user:(await signInWithEmailAndPassword(auth,e,n)).user}}catch(s){return{success:!1,error:s.message}}}static async logout(){try{return await signOut(auth),{success:!0}}catch(e){return{success:!1,error:e.message}}}static onAuthChange(e){return onAuthStateChanged(auth,e)}static getCurrentUser(){return auth.currentUser}}const AuthContext=reactExports.createContext();function AuthProvider({children:r}){let[e,n]=reactExports.useState(null);reactExports.useEffect(()=>{let o=AuthService.onAuthChange(u=>{n(u)});return()=>o()},[]);let s={user:e,login:AuthService.login,register:AuthService.register,logout:AuthService.logout};return jsxRuntimeExports.jsx(AuthContext.Provider,{value:s,children:r})}function UserPanel(){const{user:r,logout:e}=reactExports.useContext(AuthContext),n=useNavigate(),[s,o]=reactExports.useState(!1),u=async()=>{try{await e(),n("/login"),o(!1)}catch(g){console.error("Logout failed:",g)}},d=()=>{o(!s)},m="block text-white text-sm font-medium tracking-wide no-underline transition-colors duration-200 py-2 px-4 rounded-md hover:bg-white hover:text-[#00579A] w-full text-left",p="block text-white text-sm font-medium tracking-wide no-underline transition-colors duration-200 py-3 px-4 rounded-md hover:bg-white hover:text-[#00579A] border-b border-white/20 last:border-b-0";return jsxRuntimeExports.jsxs("div",{className:"w-full py-2 sm:py-2.5 px-4 shadow-md relative",style:{backgroundColor:"#00579A"},children:[jsxRuntimeExports.jsxs("div",{className:"hidden md:flex justify-end items-center space-x-2 lg:space-x-4",children:[r?jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment,{children:[jsxRuntimeExports.jsxs("span",{className:"text-white text-sm font-light mr-2 truncate max-w-[200px] lg:max-w-[250px]",children:["Hello, ",r.email||"User"]}),jsxRuntimeExports.jsx(Link,{to:"/myaccount",className:m.replace("block","inline-block").replace("w-full",""),children:"My Account"}),jsxRuntimeExports.jsx("button",{onClick:u,className:`${m.replace("block","inline-block").replace("w-full","")} !bg-transparent hover:!bg-white/20 border border-transparent hover:border-white`,children:"Logout"})]}):jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment,{children:[jsxRuntimeExports.jsx(Link,{to:"/register",className:m.replace("block","inline-block").replace("w-full",""),children:"Register"}),jsxRuntimeExports.jsx(Link,{to:"/login",className:m.replace("block","inline-block").replace("w-full",""),children:"Login"})]}),jsxRuntimeExports.jsx(Link,{to:"/contactUs",className:`${m.replace("block","inline-block").replace("w-full","")}`,children:"Contact Us"})]}),jsxRuntimeExports.jsxs("div",{className:"md:hidden flex justify-between items-center",children:[jsxRuntimeExports.jsx("div",{className:"text-white text-sm font-medium",children:r?`Hello, ${r.email?.split("@")[0]||"User"}`:"Welcome"}),jsxRuntimeExports.jsx("button",{onClick:d,className:"p-1 text-white hover:bg-white/20 rounded-md transition-colors","aria-label":"User menu",children:jsxRuntimeExports.jsx("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:jsxRuntimeExports.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:s?"M6 18L18 6M6 6l12 12":"M4 6h16M4 12h16M4 18h16"})})})]}),s&&jsxRuntimeExports.jsx("div",{className:"md:hidden absolute top-full left-0 right-0 bg-[#00579A] shadow-lg z-50 border-t border-white/20",children:jsxRuntimeExports.jsxs("div",{className:"py-2",children:[r?jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment,{children:[jsxRuntimeExports.jsx(Link,{to:"/myaccount",className:p,onClick:()=>o(!1),children:"My Account"}),jsxRuntimeExports.jsx("button",{onClick:u,className:`${p} !bg-transparent hover:!bg-white/20 border-0 text-left`,children:"Logout"})]}):jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment,{children:[jsxRuntimeExports.jsx(Link,{to:"/register",className:p,onClick:()=>o(!1),children:"Register"}),jsxRuntimeExports.jsx(Link,{to:"/login",className:p,onClick:()=>o(!1),children:"Login"})]}),jsxRuntimeExports.jsx(Link,{to:"/contactUs",className:p,onClick:()=>o(!1),children:"Contact Us"})]})})]})}const cartIcon=""+new URL("../assets/img/cart.png",import.meta.url).href;function Cart({cartCount:r=0}){return jsxRuntimeExports.jsxs("button",{className:"p-2 relative hover:bg-gray-100 rounded-full transition-colors duration-200",children:[jsxRuntimeExports.jsx("img",{src:cartIcon,alt:"Cart",className:"w-6 h-6 object-contain"}),jsxRuntimeExports.jsx("span",{className:"absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center",children:r})]})}function Saved({isFilled:r=!1}){return jsxRuntimeExports.jsx("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:r?"#3b82f6":"none",stroke:r?"#3b82f6":"currentColor",strokeWidth:"2",children:jsxRuntimeExports.jsx("path",{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"})})}const CartContext=reactExports.createContext();function CartProvider({children:r}){const[e,n]=reactExports.useState({}),[s,o]=reactExports.useState([]),[u,d]=reactExports.useState([]),[m,p]=reactExports.useState({}),_e={count:e,increase:(ve,Re="default")=>{n(Ae=>({...Ae,[ve]:{...Ae[ve],[Re]:(Ae[ve]?.[Re]||0)+1}}))},reduce:(ve,Re="default")=>{n(Ae=>({...Ae,[ve]:{...Ae[ve],[Re]:Math.max((Ae[ve]?.[Re]||0)-1,0)}}))},addProduct:(ve,Re,Ae=1)=>{o(Pe=>{const Oe=Pe.findIndex(Ve=>Ve.id===ve.id&&Ve.option===Re);return Ae<=0?Oe!==-1?Pe.filter((Ve,ie)=>ie!==Oe):Pe:Oe!==-1?Pe.map((Ve,ie)=>ie===Oe?{...Ve,quantity:Ae}:Ve):[...Pe,{...ve,option:Re,quantity:Ae}]}),n(Pe=>({...Pe,[ve.id]:{...Pe[ve.id],[Re]:Ae}}))},addProductWithReset:(ve,Re)=>{const Ae=e[ve.id]?.[Re]||1;o(Pe=>Pe.find(Ve=>Ve.id===ve.id&&Ve.option===Re)?Pe.map(Ve=>Ve.id===ve.id&&Ve.option===Re?{...Ve,quantity:Ve.quantity+Ae}:Ve):[...Pe,{...ve,option:Re,quantity:Ae}]),n(Pe=>({...Pe,[ve.id]:{...Pe[ve.id],[Re]:0}}))},cart:s,updateCartQuantity:(ve,Re,Ae)=>{o(Pe=>Pe.map(Oe=>Oe.id===ve&&Oe.option===Ae?{...Oe,quantity:Math.max(Oe.quantity+Re,0)}:Oe).filter(Oe=>Oe.quantity>0))},clearCart:()=>{o([]),n({})},favorite:u,addFavorite:ve=>{d(Re=>Re.find(Pe=>Pe.id===ve.id)?Re.filter(Pe=>Pe.id!==ve.id):[...Re,ve]),p(Re=>({...Re,[ve.id]:!0}))},favoriteStatus:m,setFavoriteStatus:p};return jsxRuntimeExports.jsx(CartContext.Provider,{value:_e,children:r})}function ScrollToTopButton(){const[r,e]=reactExports.useState(!1);reactExports.useEffect(()=>{const s=()=>{window.scrollY>400?e(!0):e(!1)};return window.addEventListener("scroll",s),()=>window.removeEventListener("scroll",s)},[]);const n=()=>{window.scrollTo({top:0,behavior:"smooth"})};return jsxRuntimeExports.jsx("button",{onClick:n,"aria-label":"Scroll to top",className:`
